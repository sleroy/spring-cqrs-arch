...
/**
 * The Class CqrsDebuggerInterceptor defines the component that observes any notifications
 * from the Event bus and the Gate.
 */

@EventHandler
@Profile({"debug_cqrs"})
public class CqrsDebuggerInterceptor implements CommandInterceptor {
